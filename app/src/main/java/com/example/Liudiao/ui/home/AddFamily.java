            ...
            public void onClick(View v) {
                ...
                if (!name.getText().toString().equals("") && !phone.getText().toString().equals("") && s!=null ){
                    if (isMobilPhone(phone.getText().toString())){
                        ...
                        builder = new AlertDialog.Builder(AddFamily.this).setTitle("重要提醒")
                                                            ...
                                                            try {
                                                                ...
                                                                if (isAddSuccess == 0) {
                                                                    runOnUiThread(new Runnable() {
                                                                        @Override
                                                                        public void run() {
                                                                            Toast.makeText(AddFamily.this, "添加成功！", Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    });
                                                                    ...
                                                                    runOnUiThread(new Runnable() {
                                                                        @Override
                                                                        public void run() {
                                                                            Toast.makeText(AddFamily.this, "库中已存在该人，与所填写不符，如有疑问请联系运维人员", Toast.LENGTH_LONG).show();
                                                                    ...
                                                                    runOnUiThread(new Runnable() {
                                                                        @Override
                                                                        public void run() {
                                                                            Toast.makeText(AddFamily.this, "添加失败！", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(AddFamily.this,"请填写正确的手机号码！",Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(AddFamily.this,"请填写完整信息！",Toast.LENGTH_SHORT).show();
                }
            }
        });
