...
public class FamilyAlter extends AppCompatActivity {
    ...
    private String[] relationList = {"","父亲","母亲","儿子","女儿","夫妻","兄弟","姐妹","（外）祖父母","（外）孙子孙女","其他关系"} ;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alter_family);
        ...
        int relation1 = intent.getIntExtra("relation",0);
        ...
        relation.setSelection(relation1);
                            ...
                            try {
                                if (cc.IDCardValidate(idCard.getText().toString()) == "") {
                                    ...
                                    new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            try {
                                                String postUrl = "http://175.23.169.100:9040/family/updateFamily";
                                                ...
                                                if (isAddSuccess == 0) {
                                                    ...
                                                    runOnUiThread(new Runnable() {
                                                        @Override
                                                        public void run() {
                                                            Toast.makeText(FamilyAlter.this, "修改成功！", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    runOnUiThread(new Runnable() {
                                                        @Override
                                                        public void run() {
                                                            Toast.makeText(FamilyAlter.this, "库中已存在该人，与所填写不符，如有疑问请联系运维人员", Toast.LENGTH_LONG).show();
                                                    ...
                                                    runOnUiThread(new Runnable() {
                                                        @Override
                                                        public void run() {
                                                            Toast.makeText(FamilyAlter.this, "修改失败！", Toast.LENGTH_SHORT).show();
...
//                                    finish();
                                    ...
                                    Toast.makeText(FamilyAlter.this,cc.IDCardValidate(idCard.getText().toString()),Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(FamilyAlter.this,"请填写正确的手机号码！",Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(FamilyAlter.this,"请填写完整信息！",Toast.LENGTH_SHORT).show();
                }
            }
        });
